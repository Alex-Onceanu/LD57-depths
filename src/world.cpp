...
World::World()
{
    ...
    initial [NB_TILES_X] = Tile(0,1,3,0);
    initial [2*NB_TILES_X-1] = Tile(0,3,1,0);
    for (int i = 2; i< NB_TILES_Y; i++){
        initial[i*NB_TILES_X] = Tile(1,1,3,3);
        initial[(i+1)*NB_TILES_X-1] = Tile(3,3,1,1);
    }
